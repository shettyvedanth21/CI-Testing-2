...
class TariffRequest(BaseModel):
    tenant_id: str
    energy_rate_per_kwh: Decimal = Field(gt=0)
    demand_charge_per_kw: Decimal = Field(default=Decimal("0"), ge=0)
    reactive_penalty_rate: Decimal = Field(default=Decimal("0"), ge=0)
    fixed_monthly_charge: Decimal = Field(default=Decimal("0"), ge=0)
    power_factor_threshold: Decimal = Field(default=Decimal("0.90"), gt=0, le=1)
    currency: str = "INR"
